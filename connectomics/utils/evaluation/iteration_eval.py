...
def cal_infer(root_dir, model_id, output_path):
    """
    ...
    command = "python {}scripts/main.py --config-file\
                ...
                INFERENCE.AUG_NUM\
                0\
            ".format(root_dir, root_dir, root_dir, output_path, model_id, root_dir)
    ...
    command = "python {}connectomics/utils/evaluation/evaluate.py \
                 -gt \
                 /home/omkarthawakar/fahad_sir/MitoEM_dataset/EM30-R-mito-train-val-v2/rat_val_gt.h5 \
                 -p \
...
if __name__=="__main__":
    ...
    parser.add_argument('--root-path', type=str, default="/home/omkarthawakar/fahad_sir/MitoEM2021-Challenge", help='root dir path')
    parser.add_argument('--gt-path', type=str, default="/home/omkarthawakar/fahad_sir/MitoEM_dataset/EM30-R-mito-train-val-v2/rat_val_gt.h5", help='root dir path')
    parser.add_argument('--ngpus', type=int, default=1, help='gpu number')
    parser.add_argument('--ncpus', type=int, default=8, help='cpu number')
    parser.add_argument('--bs', type=int, default=0, help='total batch size')
    ...
    for i in range(len(model_id)):
        command = ["python {}scripts/main.py ".format(root_dir),
        ...
        command = ["python {}connectomics/utils/evaluation/evaluate.py".format(root_dir),
                 "-gt", args.gt_path,
