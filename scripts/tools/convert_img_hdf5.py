...
img_shape = (4096, 4096)
pred_dir = '/home/omkarthawakar/fahad_sir/MitoEM_dataset/EM30-R-mito-train-val-v2/mito-val-v2'
pred_ids = sorted(next(os.walk(pred_dir))[2])
h5file_name = '/home/omkarthawakar/fahad_sir/MitoEM_dataset/EM30-R-mito-train-val-v2/rat_val_gt.h5'
